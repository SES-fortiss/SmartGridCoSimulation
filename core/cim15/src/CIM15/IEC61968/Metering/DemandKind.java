...
public enum DemandKind implements Enumerator {
	 ...
	 * @ordered
	 */
	FIXED_BLOCK(0, "fixedBlock", "fixedBlock"),
	 ...
	 * @ordered
	 */
	ROLLING_BLOCK(1, "rollingBlock", "rollingBlock"),
	 ...
	 * @ordered
	 */
	public static final int FIXED_BLOCK_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int ROLLING_BLOCK_VALUE = 1;
