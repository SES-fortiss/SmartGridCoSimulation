 ...
 * @generated
 */
public class LoadControlSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case LoadControlPackage.CONNECT_DISCONNECT_FUNCTION: {
				...
				if (result == null) result = caseElement(connectDisconnectFunction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LoadControlPackage.REMOTE_CONNECT_DISCONNECT_INFO: {
