 ...
 * @generated
 */
public enum SpillwayGateType implements Enumerator {
	;
	 ...
	 * @generated
	 */
	public static final List<SpillwayGateType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
