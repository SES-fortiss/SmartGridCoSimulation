 ...
 * <ul>
 *   <li>{@link CIM15.IEC61970.Informative.InfERPSupport.ErpInventory#getAsset <em>Asset</em>}</li>
 *   <li>{@link CIM15.IEC61970.Informative.InfERPSupport.ErpInventory#getStatus <em>Status</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ErpInventory extends IdentifiedObject {
	/**
	 ...
	 * It is bidirectional and its opposite is '{@link CIM15.IEC61968.Assets.Asset#getErpInventory <em>Erp Inventory</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link CIM15.IEC61970.Informative.InfERPSupport.ErpInventory#getAsset <em>Asset</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link CIM15.IEC61970.Informative.InfERPSupport.ErpInventory#getStatus <em>Status</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setStatus(Status newStatus) {
		if (newStatus != status) {
			NotificationChain msgs = null;
			if (status != null)
				msgs = ((InternalEObject)status).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - InfERPSupportPackage.ERP_INVENTORY__STATUS, null, msgs);
			if (newStatus != null)
				msgs = ((InternalEObject)newStatus).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - InfERPSupportPackage.ERP_INVENTORY__STATUS, null, msgs);
