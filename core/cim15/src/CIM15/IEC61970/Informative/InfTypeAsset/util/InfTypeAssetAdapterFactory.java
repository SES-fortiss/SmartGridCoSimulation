/**
 */
package CIM15.IEC61970.Informative.InfTypeAsset.util;
...
import CIM15.IEC61970.Informative.InfTypeAsset.*;
 ...
 * <!-- end-user-doc -->
 * @see CIM15.IEC61970.Informative.InfTypeAsset.InfTypeAssetPackage
 * @generated
 */
public class InfTypeAssetAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public InfTypeAssetAdapterFactory() {
	 ...
	 * @generated
	 */
	protected InfTypeAssetSwitch<Adapter> modelSwitch =
		new InfTypeAssetSwitch<Adapter>() {
			@Override
			public Adapter caseTypeAssetCatalogue(TypeAssetCatalogue object) {
				return createTypeAssetCatalogueAdapter();
			}
			@Override
			public Adapter caseGeneratorTypeAsset(GeneratorTypeAsset object) {
				return createGeneratorTypeAssetAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link CIM15.IEC61970.Informative.InfTypeAsset.TypeAssetCatalogue <em>Type Asset Catalogue</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link CIM15.IEC61970.Informative.InfTypeAsset.GeneratorTypeAsset <em>Generator Type Asset</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGeneratorTypeAssetAdapter() {
		return null;
	}
