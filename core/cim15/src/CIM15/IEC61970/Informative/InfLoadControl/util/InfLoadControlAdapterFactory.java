 ...
 * @generated
 */
public class InfLoadControlAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public InfLoadControlAdapterFactory() {
	 ...
	 * @generated
	 */
	protected InfLoadControlSwitch<Adapter> modelSwitch =
		new InfLoadControlSwitch<Adapter>() {
			@Override
			public Adapter caseLoadMgmtRecord(LoadMgmtRecord object) {
				return createLoadMgmtRecordAdapter();
			}
			@Override
			public Adapter caseLoadShedFunction(LoadShedFunction object) {
				return createLoadShedFunctionAdapter();
			}
			@Override
			public Adapter caseLoadMgmtFunction(LoadMgmtFunction object) {
				return createLoadMgmtFunctionAdapter();
			}
			@Override
			public Adapter caseLoadLimitFunction(LoadLimitFunction object) {
				return createLoadLimitFunctionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link CIM15.IEC61970.Informative.InfLoadControl.LoadMgmtRecord <em>Load Mgmt Record</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createLoadMgmtRecordAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link CIM15.IEC61970.Informative.InfLoadControl.LoadShedFunction <em>Load Shed Function</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createLoadShedFunctionAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link CIM15.IEC61970.Informative.InfLoadControl.LoadMgmtFunction <em>Load Mgmt Function</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createLoadMgmtFunctionAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link CIM15.IEC61970.Informative.InfLoadControl.LoadLimitFunction <em>Load Limit Function</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createLoadLimitFunctionAdapter() {
		return null;
	}
