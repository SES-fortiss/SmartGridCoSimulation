 ...
 * <ul>
 *   <li>{@link CIM15.IEC61970.Informative.InfWork.CUAllowableAction#getCompatibleUnits <em>Compatible Units</em>}</li>
 *   <li>{@link CIM15.IEC61970.Informative.InfWork.CUAllowableAction#getStatus <em>Status</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CUAllowableAction extends IdentifiedObject {
	/**
	 ...
	 * It is bidirectional and its opposite is '{@link CIM15.IEC61970.Informative.InfWork.CompatibleUnit#getCUAllowableAction <em>CU Allowable Action</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link CIM15.IEC61970.Informative.InfWork.CUAllowableAction#getStatus <em>Status</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setStatus(Status newStatus) {
		if (newStatus != status) {
			...
			if (status != null)
				msgs = ((InternalEObject)status).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - InfWorkPackage.CU_ALLOWABLE_ACTION__STATUS, null, msgs);
			if (newStatus != null)
				msgs = ((InternalEObject)newStatus).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - InfWorkPackage.CU_ALLOWABLE_ACTION__STATUS, null, msgs);
