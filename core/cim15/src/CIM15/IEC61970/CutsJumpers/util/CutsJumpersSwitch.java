 ...
 * @generated
 */
public class CutsJumpersSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CutsJumpersPackage.CUT: {
				...
				if (result == null) result = caseElement(cut);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CutsJumpersPackage.CLAMP: {
				...
				if (result == null) result = caseElement(clamp);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
