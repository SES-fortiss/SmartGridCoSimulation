 ...
 * <ul>
 *   <li>{@link CIM15.IEC61970.CutsJumpers.Clamp#getLengthFromTerminal1 <em>Length From Terminal1</em>}</li>
 *   <li>{@link CIM15.IEC61970.CutsJumpers.Clamp#getACLineSegment <em>AC Line Segment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Clamp extends ConductingEquipment {
	...
	protected EClass eStaticClass() {
		return CutsJumpersPackage.Literals.CLAMP;
	}
	...
	/**
	 * Sets the value of the '{@link CIM15.IEC61970.CutsJumpers.Clamp#getLengthFromTerminal1 <em>Length From Terminal1</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link CIM15.IEC61970.CutsJumpers.Clamp#getLengthFromTerminal1 <em>Length From Terminal1</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetLengthFromTerminal1()
	 * @see #getLengthFromTerminal1()
	...
	/**
	 * Returns whether the value of the '{@link CIM15.IEC61970.CutsJumpers.Clamp#getLengthFromTerminal1 <em>Length From Terminal1</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM15.IEC61970.Wires.ACLineSegment#getClamp <em>Clamp</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link CIM15.IEC61970.CutsJumpers.Clamp#getACLineSegment <em>AC Line Segment</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setACLineSegment(ACLineSegment newACLineSegment) {
		if (newACLineSegment != acLineSegment) {
			...
			if (acLineSegment != null)
				msgs = ((InternalEObject)acLineSegment).eInverseRemove(this, WiresPackage.AC_LINE_SEGMENT__CLAMP, ACLineSegment.class, msgs);
			if (newACLineSegment != null)
				msgs = ((InternalEObject)newACLineSegment).eInverseAdd(this, WiresPackage.AC_LINE_SEGMENT__CLAMP, ACLineSegment.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CutsJumpersPackage.CLAMP__AC_LINE_SEGMENT:
				if (acLineSegment != null)
					msgs = ((InternalEObject)acLineSegment).eInverseRemove(this, WiresPackage.AC_LINE_SEGMENT__CLAMP, ACLineSegment.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CutsJumpersPackage.CLAMP__LENGTH_FROM_TERMINAL1:
