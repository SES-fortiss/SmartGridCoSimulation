 ...
 * @generated
 */
public class WiresPhaseModelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case WiresPhaseModelPackage.SWITCH_PHASE: {
				...
				if (result == null) result = caseElement(switchPhase);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WiresPhaseModelPackage.SHUNT_COMPENSATOR_PHASE: {
				...
				if (result == null) result = caseElement(shuntCompensatorPhase);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WiresPhaseModelPackage.ENERGY_CONSUMER_PHASE: {
				...
				if (result == null) result = caseElement(energyConsumerPhase);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
