/**
 */
package CIM15.IEC61970.WiresPhaseModel.util;
...
import CIM15.IEC61970.WiresPhaseModel.*;
 ...
 * <!-- end-user-doc -->
 * @see CIM15.IEC61970.WiresPhaseModel.WiresPhaseModelPackage
 * @generated
 */
public class WiresPhaseModelAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static WiresPhaseModelPackage modelPackage;
	 ...
	 * @generated
	 */
	public WiresPhaseModelAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = WiresPhaseModelPackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected WiresPhaseModelSwitch<Adapter> modelSwitch =
		new WiresPhaseModelSwitch<Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link CIM15.IEC61970.WiresPhaseModel.SwitchPhase <em>Switch Phase</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link CIM15.IEC61970.WiresPhaseModel.ShuntCompensatorPhase <em>Shunt Compensator Phase</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link CIM15.IEC61970.WiresPhaseModel.EnergyConsumerPhase <em>Energy Consumer Phase</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
