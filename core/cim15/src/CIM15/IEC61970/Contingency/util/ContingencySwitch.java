 ...
 * @generated
 */
public class ContingencySwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ContingencyPackage.CONTINGENCY_EQUIPMENT: {
				...
				if (result == null) result = caseElement(contingencyEquipment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ContingencyPackage.CONTINGENCY: {
				...
				if (result == null) result = caseElement(contingency);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ContingencyPackage.CONTINGENCY_ELEMENT: {
				...
				if (result == null) result = caseElement(contingencyElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
