 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see CIM15.PackageDependencies.PackageDependenciesFactory
 * @generated
 */
public class PackageDependenciesPackage extends EPackageImpl {
	/**
	 * The package name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final String eNAME = "PackageDependencies";
	 ...
	 * @generated
	 */
	public static final String eNS_URI = "http://iec.ch/TC57/2010/CIM-schema-cim15#PackageDependencies";
	 ...
	 * @generated
	 */
	public static final String eNS_PREFIX = "cimPackageDependencies";
	 ...
	 * @generated
	 */
	public static final PackageDependenciesPackage eINSTANCE = CIM15.PackageDependencies.PackageDependenciesPackage.init();

	/**
	 * The meta object id for the '{@link CIM15.PackageDependencies.PackageDependenciesCIMVeresion <em>CIM Veresion</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see CIM15.PackageDependencies.PackageDependenciesCIMVeresion
	 * @see CIM15.PackageDependencies.PackageDependenciesPackage#getPackageDependenciesCIMVeresion()
	 * @generated
	 */
	public static final int PACKAGE_DEPENDENCIES_CIM_VERESION = 0;
	 ...
	 * @ordered
	 */
	public static final int PACKAGE_DEPENDENCIES_CIM_VERESION__UUID = CIM15Package.ELEMENT__UUID;
	 ...
	 * @ordered
	 */
	public static final int PACKAGE_DEPENDENCIES_CIM_VERESION__VESION = CIM15Package.ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	public static final int PACKAGE_DEPENDENCIES_CIM_VERESION__DATE = CIM15Package.ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	public static final int PACKAGE_DEPENDENCIES_CIM_VERESION_FEATURE_COUNT = CIM15Package.ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	public static final int PACKAGE_DEPENDENCIES_CIM_VERESION_OPERATION_COUNT = CIM15Package.ELEMENT_OPERATION_COUNT + 0;
	 ...
	 * @generated
	 */
	private EClass packageDependenciesCIMVeresionEClass = null;
	 ...
	 * @see CIM15.PackageDependencies.PackageDependenciesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private PackageDependenciesPackage() {
		super(eNS_URI, PackageDependenciesFactory.INSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link PackageDependenciesPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static PackageDependenciesPackage init() {
		if (isInited) return (PackageDependenciesPackage)EPackage.Registry.INSTANCE.getEPackage(PackageDependenciesPackage.eNS_URI);

		// Obtain or create and register package
		PackageDependenciesPackage thePackageDependenciesPackage = (PackageDependenciesPackage)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof PackageDependenciesPackage ? EPackage.Registry.INSTANCE.get(eNS_URI) : new PackageDependenciesPackage());
		...
		thePackageDependenciesPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(PackageDependenciesPackage.eNS_URI, thePackageDependenciesPackage);
		return thePackageDependenciesPackage;
	}


	/**
	 * Returns the meta object for class '{@link CIM15.PackageDependencies.PackageDependenciesCIMVeresion <em>CIM Veresion</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public EClass getPackageDependenciesCIMVeresion() {
		if (packageDependenciesCIMVeresionEClass == null) {
			packageDependenciesCIMVeresionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PackageDependenciesPackage.eNS_URI).getEClassifiers().get(0);
		}
		return packageDependenciesCIMVeresionEClass;
	}

	/**
	 * Returns the meta object for the attribute '{@link CIM15.PackageDependencies.PackageDependenciesCIMVeresion#getVesion <em>Vesion</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Vesion</em>'.
	 * @see CIM15.PackageDependencies.PackageDependenciesCIMVeresion#getVesion()
	 * @see #getPackageDependenciesCIMVeresion()
	 * @generated
	 */
	public EAttribute getPackageDependenciesCIMVeresion_Vesion() {
        return (EAttribute)getPackageDependenciesCIMVeresion().getEStructuralFeatures().get(0);
	}

	/**
	 * Returns the meta object for the attribute '{@link CIM15.PackageDependencies.PackageDependenciesCIMVeresion#getDate <em>Date</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Date</em>'.
	 * @see CIM15.PackageDependencies.PackageDependenciesCIMVeresion#getDate()
	 * @see #getPackageDependenciesCIMVeresion()
	 * @generated
	 */
	public EAttribute getPackageDependenciesCIMVeresion_Date() {
        return (EAttribute)getPackageDependenciesCIMVeresion().getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public PackageDependenciesFactory getPackageDependenciesFactory() {
		return (PackageDependenciesFactory)getEFactoryInstance();
	}
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("CIM15.PackageDependencies." + eClassifier.getName());
	...
	public interface Literals {
		/**
		 * The meta object literal for the '{@link CIM15.PackageDependencies.PackageDependenciesCIMVeresion <em>CIM Veresion</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see CIM15.PackageDependencies.PackageDependenciesCIMVeresion
		 * @see CIM15.PackageDependencies.PackageDependenciesPackage#getPackageDependenciesCIMVeresion()
		 * @generated
		 */
		public static final EClass PACKAGE_DEPENDENCIES_CIM_VERESION = eINSTANCE.getPackageDependenciesCIMVeresion();
		 ...
		 * @generated
		 */
		public static final EAttribute PACKAGE_DEPENDENCIES_CIM_VERESION__VESION = eINSTANCE.getPackageDependenciesCIMVeresion_Vesion();
		 ...
		 * @generated
		 */
		public static final EAttribute PACKAGE_DEPENDENCIES_CIM_VERESION__DATE = eINSTANCE.getPackageDependenciesCIMVeresion_Date();
