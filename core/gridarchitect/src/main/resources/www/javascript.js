...
d3.json("DEMSResults.json", function (jsondata) {
    ...
    ************************************************/ 
    ...
    function SVG2mouseclick(){
        ...
        svg2.selectAll(".bar")
            .attr("fill", function(d,i) {if(i == element_index){return "orange"} else {return "green"}})    
    ...
    function generateText(){
        ...
        return "Eigenschaften <hr> " + 
            ...
            "Vorhersage: " + format_k(t.data[counter].expectedProduction) + " kW<br>"
    }
