...
/**
 * This class represents the basic Parameter of an Actor Behavior. The extension, i.e. a concrete
 * BegaviorModel, shall include the expected parameters such as installed capacity, etc.
 * 
 * @author bytschkow
 */
...
public abstract class BehaviorModel {
   ...
   * This method can be used to close open FileWriters or Communication Channels. <br>
   */
