...
public class LandwirtschaftModel extends BehaviorModel {
	
	public HouseToAggregator answerContentToSend = new HouseToAggregator();
	public TypKlasse typ = TypKlasse.LANDWIRTSCHAFT; 
	
	double jahresVerbrauch;
	public LandwirtschaftRecorder recorder;
	
	public LandwirtschaftModel(double jahresVerbrauch){
	...
	public void handleRequest() {
		if ((this.recorder == null)) {
			this.recorder = new LandwirtschaftRecorder(this);	
		}
	}
	...
	public void makeDecision() {
		...
		answerContentToSend.verbrauch = LastProfilTennet.getLoadAgriculture(jahresVerbrauch, actualTimeValue);
