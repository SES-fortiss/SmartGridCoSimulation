...
//		return electricityProfile.get(consumptionIndex).get(timestep % heatProfiles.size());
	...
	private void read(BufferedReader br, HashMap<Integer, ArrayList<Double>> dailyProfiles, HashMap<Integer, ArrayList<Double>> profiles) throws IOException, ParseException{
    	...
    	while ( (zeile = br.readLine()) != null) {		
			buffer = zeile.split(";");	
			// Zur Korrektur des Zeitschritts werden 143 Zeitschritte �bersprungen
	 ...
	 // Das W�rmeprofil eines Tages wird auf n_days kopiert
...
//  Hier werden 144 Minuten/Eintr�ge aus dem csv Zusammengefasst damit sie dem Zeitschritt 2,4 Std der Sim entsprechen		
