...
//		top.addActorAsChild(simulationName + "/Consumption", ActorFactory.createConsumer("/Consumption", port++));
		...
		Integer heatTransportLengthB2 = 50;
		...
		Integer heatTransportLengthB3 = 50;
		...
		Integer heatTransportLengthB4 = 50;
		...
		Integer heatTransportLengthB5 = 50;
...
//		Integer heatTransportLengthB6 = 50;
