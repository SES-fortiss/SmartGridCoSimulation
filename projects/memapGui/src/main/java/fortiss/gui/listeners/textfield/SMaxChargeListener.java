...
public class SMaxChargeListener extends KeyAdapter implements FocusListener {
	...
	public void focusLost(FocusEvent e) {
		if (!valid) {
			String currentVal = Double.toString(o.getMaxCharging());
	...
	public void keyReleased(KeyEvent e) {
		...
		if (check) {
			...
			if (!containsNumber) {
				...
				valid = true;
				o.setMaxCharging(Double.parseDouble(input));
			}
		}
	}
