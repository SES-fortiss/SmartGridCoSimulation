...
public class SMaxDischargeListener extends KeyAdapter implements FocusListener {
	...
	public void focusGained(FocusEvent e) {
		...
		o = DesignerPanel.buildings.get(building).getStorage().get(component);
		check = false;
		valid = true;
	...
	public void focusLost(FocusEvent e) {
		if (!valid) {
			String currentVal = Double.toString(o.getMaxDischarging());
	...
	public void keyReleased(KeyEvent e) {
		...
		if (check) {
			...
			if (!containsNumber) {
				...
				valid = true;
				o.setMaxDischarging(Double.parseDouble(input));
			}
		}
	}
