...
public class DNetworkTypeListener extends MouseAdapter implements ItemListener {
	...
	public void itemStateChanged(ItemEvent e) {
		...
		if (e.getStateChange() == ItemEvent.SELECTED) {
			...
			if (userSelection) {
				...
				Designer.buildings.get(building).getDemand().get(component).setNetworkType(sel);
			}
			userSelection = false;
		}
	}
