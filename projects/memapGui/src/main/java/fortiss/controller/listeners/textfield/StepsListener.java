package fortiss.controller.listeners.textfield;
...
public class StepsListener extends KeyAdapter implements FocusListener {
	...
	public void focusLost(FocusEvent e) {
		if (!valid) {
			String currentVal = Integer.toString(Designer.control.pars.getSteps());
	...
	public void keyReleased(KeyEvent e) {
		...
		if (check) {
			if (input.isEmpty()) {
				...
				valid = true;
				Designer.control.pars.setSteps(Integer.parseUnsignedInt(input));
			}
		}
	}
