...
public class MILPWithConnectionsMetricsHandler implements MetricsHandler {
	...
	public MILPWithConnectionsMetricsHandler(TopologyController tc, ArrayList<BuildingMessage> buildingMessages,
