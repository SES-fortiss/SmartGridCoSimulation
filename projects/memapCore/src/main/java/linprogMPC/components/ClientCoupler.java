...
public class ClientCoupler extends Coupler {
	 ...
	 * @param port
	 */
	public ClientCoupler(BasicClient client, String name, NodeId installedPowerId, NodeId minPowerId, NodeId effHeatId, NodeId effElecId,
		...
		super(name, client.readFinalDoubleValue(installedPowerId), client.readFinalDoubleValue(minPowerId), client.readFinalDoubleValue(effHeatId),
