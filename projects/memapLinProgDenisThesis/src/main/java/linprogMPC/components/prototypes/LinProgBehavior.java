...
//			System.out.println("Das muss der jetzt auch immer ausgeben.");
	    ...
	    optResult.buildingResultsMap.put("GeneralResults", new TreeMap<String, double[]>());
	    ...
	    // folders. The first loop runs over the these datapoints and devices. The
	    // second loop runs over the respective nMpc Hoirzon points.
		...
		if (nameCategories.contains(str.split("\\.")[0])) {
		    ...
		    keyMap = (TreeMap<String, double[]>) optResult.buildingResultsMap.get("GeneralResults");
		}
