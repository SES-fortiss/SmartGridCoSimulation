...
public class ThesisTopologySimpleSingle {
	...
	building1.addActorAsChild(building1Name + "/Consumption",
		ActorFactory.createConsumer(consumptionProfiles, 0, PORT_UNDEFINED));
	...
	building2.addActorAsChild(building2Name + "/Consumption",
		ActorFactory.createConsumer(consumptionProfiles, 1, PORT_UNDEFINED));
	...
	building2.addActorAsChild(building2Name + "/Battery2",
		ActorFactory.createBattery(12.0, 9, 9, 0.95, 0.95, PORT_UNDEFINED));
	...
	building3.addActorAsChild(building3Name + "/Consumption",
		ActorFactory.createConsumer(consumptionProfiles, 2, PORT_UNDEFINED));
	...
	// ActorFactory.createPV(12.0+5.0, PORT_UNDEFINED));
	building3.addActorAsChild(building3Name + "/HeatPump3",
		ActorFactory.createHeatPump(25, 2.5, -1, PORT_UNDEFINED));
	...
	// building3.addActorAsChild(building3Name + "/ThermalStorage3",
	// ActorFactory.createThermalStorage(3*100, 3*60, 3*60, 0.9, 0.9,
	// PORT_UNDEFINED));
	...
	building4.addActorAsChild(building4Name + "/Consumption",
		ActorFactory.createConsumer(consumptionProfiles, 3, PORT_UNDEFINED));
	...
	building5.addActorAsChild(building5Name + "/Consumption",
		ActorFactory.createConsumer(consumptionProfiles, 4, PORT_UNDEFINED));
	...
	building5.addActorAsChild(building5Name + "/SolarThermic5",
		ActorFactory.createSolarThermic(10, PORT_UNDEFINED));
