...
public class ThesisTopologySimple {
	private static String simulationName = "LinProgDenis";	
	...
	public static final int TIMESTEPS_PER_DAY = 96; // Timesteps muss ganze Minuten ergeben.
	public static final int NR_OF_ITERATIONS =  1*TIMESTEPS_PER_DAY; // 2 Days
	public static final int N_STEPS = NR_OF_ITERATIONS + N_STEPS_MPC; // benötigt man damit der Optimierer funktioniert.
	
	public static final boolean MEMAP_ON = true;
	...
	public static ActorTopology createTopology(){
		...
		building2.addActorAsChild(building2Name + "/PV2", ActorFactory.createPV(8.0, PORT_UNDEFINED));
		building2.addActorAsChild(building2Name + "/Battery2", ActorFactory.createBattery(12.0, 9, 9, 0.95, 0.95, PORT_UNDEFINED));
		//building2.addActorAsChild(building2Name + "/Consumption2x", ActorFactory.createConsumer(consumptionProfiles, 0, PORT_UNDEFINED));
		//building2.addActorAsChild(building2Name + "/GasBoiler2x", ActorFactory.createGasBoiler(20, 0.95, 0.0685, PORT_UNDEFINED));
		...
		building3.addActorAsChild(building3Name + "/PV3", ActorFactory.createPV(24.0, PORT_UNDEFINED));
		...
		building4.addActor(building4Name, ActorFactory.createBuilding(port++, false, 50));
		...
		building5.addActor(building5Name, ActorFactory.createBuilding(port++, false, 50));
