...
/**
 *
 * Topology for example with 5 buildings with MILP
 * 
 * @author andreas.thut, mayer, bytschkow
 */
public class TopologySimpleSingle {
	...
	public static ActorTopology createTopology(int mpcInput,boolean memapActive){
		TopologySimple.N_STEPS_MPC = mpcInput;
		...
		building1.addActorAsChild(building1Name + "/OilBoiler1", ActorFactory.createGasBoiler(20, 0, 0.95, 0.0685, PORT_UNDEFINED));		
		...
		building2.addActorAsChild(building2Name + "/GasBoiler2", ActorFactory.createGasBoiler(20, 0, 0.98, 0.0591, PORT_UNDEFINED));
