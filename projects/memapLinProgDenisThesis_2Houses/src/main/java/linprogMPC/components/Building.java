...
public class Building extends BehaviorModel {
	...
	public void makeDecision() {	
        ...
        //	======================  OPC UA Read  =====================	
//		
//		// Parse BuildingNumber from String e.g. "Building2"
//		int BuildingNumber = Integer.parseInt(this.actorName.substring(this.actorName.length() - 1)); 
//				
//	//	if (BuildingNumber > 3) {
//	//		BuildingNumber = 3;	
//	//	} 
...
//		
//		
//		NodeSpace BuildingNodeSpace = new NodeSpace(this.actor.getBasicActor().childrenNameList);
//		System.out.println("Gebäude " + BuildingNumber + " hat " + BuildingNodeSpace.getChildNames());
//		
//		
////		this.actor.getBasicActor().childrenNameList.forEach(System.out::println);
//		 
//		 
//		// BuildingNodeSpace.createNodesFromChildren();		
//		List<NodeId> InputNodes = BuildingNodeSpace.getInputNodes();
//		
////        for (NodeId rootNode : InputNodes) {
////        	if (rootNode != null) {
////        		System.out.println("Browsing " + rootNode.toString());
////        	} else {
////        		System.out.println("Error: rootNode is empty!");
////        	}
////        }
//		
//		try {	
//			ReadClient.startClient(InputNodes);
//			// (4*BuildingNumber+2)
...
//			// JMr added for control
//			SolutionHandler.exportVector(optSolution, "XvectorMEMAP.csv");
