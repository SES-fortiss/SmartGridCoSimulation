...
public class TopologyNoControl {
	...
	public static ActorTopology createTopology(){
		 ...
		 *  Actor Topology
		 */
		top.addActor("DEMS", DEMSActorFactory.createDEMSNoSchedule());
		...
		*/
		...
		//top.addActorAsChild("DEMS/"+"BioGas---Unzuverlaessig", DEMSActorFactory.createUnreliableBioGasActor("Unzuverlaessig", 100.0));
