...
public class ConsumptionProfiles {
	...
	public ConsumptionProfiles(int nrOfProfiles) {
		...
		// Achtung angepasst bedeuted Reihenfolge der Häuser 1,2,3,4,5 statt 1,3,2,4,5
	...
	private HashMap<Integer, ArrayList<Double>> readConsumption(String filename, int nrOfProfiles){
		...
		try {
			...
			readPlusInterpolate(br, dailyProfiles, profiles);		    
	 ...
	 */
	private void readPlusInterpolate(BufferedReader br, HashMap<Integer, ArrayList<Double>> dailyProfiles, HashMap<Integer, ArrayList<Double>> profiles) throws IOException, ParseException{
