...
public class SolarRadiation {
	...
	// private static final String SOLARPRODUCTION_FILENAME =
	// "Discovergy_PVAnlage15kWp_badDay.csv";

	private ArrayList<Double> solarProductionPerKWp;

	public SolarRadiation() {
		// Production of a 15kWp solar installation (source:
		// https://my.discovergy.com/export?9
	...
	private void readProd(BufferedReader br, ArrayList<Double> solarProductionPerKWp)
		...
		int timestepsPerDay = MemapConfig.TIMESTEPS_PER_DAY;
